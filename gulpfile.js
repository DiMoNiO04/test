...
const paths = {
  ...
  srcHtml: `${srcFolder}/html/pages/**/*`,
  srcTemplatesFolder: `${srcFolder}/html/templates`,
...
const fonts = () => src(`${paths.fontsFolder}/**`).pipe(dest(`${buildFolder}/assets/fonts/`));
...
const watchFiles = () => {
  ...
  watch(`${paths.srcTemplatesFolder}/*.html`, htmlInclude);
...
exports.default = series(clean, htmlInclude, scripts, styles, fonts, images, webpImages, svgSprites, watchFiles);

exports.backend = series(clean, htmlInclude, scriptsBackend, stylesBackend, fonts, images, webpImages, svgSprites);

exports.build = series(toProd, clean, htmlInclude, scripts, styles, fonts, images, webpImages, svgSprites, htmlMinify);
